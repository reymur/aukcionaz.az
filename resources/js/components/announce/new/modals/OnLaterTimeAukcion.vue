            ...
            <div class="d-flex align-self-center">
                <div class="d-sm-flex d-md-flex d-lg-flex d-xl-flex d-xxl-flex aukcion-load">
                    ...
                    <div class="d-flex justify-content-center">
                        <div class="d-flex justify-content-center horus-later-and-minute-div">
                            <div class="horus-later-section me-1"> _ </div>
                            <div class="dot-later"> : </div>
                            <div class="minute-later-section ms-1"> _ </div>
                        </div>
...
export default {
    ...
    watch:{
        reset_al_time(){
            if( this.reset_al_time ) {
                this.timeReset();
            }
        },
        horus() {
            let horus_and_later_minute_div = document.getElementsByClassName('horus-and-later-minute-div');
            ...
            if( horus_and_later_minute_div && horus_and_later_minute_div[0] ) {
                horus_and_later_minute_div[0].style = 'border-bottom: 1px solid #000'
            }
        },
        minute() {
            let horus_and_later_minute_div = document.getElementsByClassName('horus-later-and-minute-div');
    ...
    methods:{
        horusFunc() {
            this.setInnerText( this.horus, 'saat', 'horus-later-section');
        },
        minuteFunc() {
            this.setInnerText( this.minute, 'dəyqə', 'minute-later-section');
        },
        timeReset() {
            this.horus = 'Saat';
            this.minute = 'Dəyqə'
            this.setInnerText( '_', false, 'horus-later-section');
            this.setInnerText( '_', false, 'minute-later-section');

            let border_remove = setInterval( () => {
                let horus_and_later_minute_div = document.getElementsByClassName('horus-later-and-minute-div');

                if( horus_and_later_minute_div && horus_and_later_minute_div[0] ) {
                    horus_and_later_minute_div[0].style = 'border: none;';
