<template>
    <div class="" id="new-announce-category">
        ...
        <ul class="list-group" data-bs-toggle="offcanvas" data-bs-target="#announce-new-category" aria-controls="offcanvasRight">
            <li :class="'list-group-item col-12 d-flex border-0 '+image_padding+' shadow-sm'" id="category">
                ...
                <div v-else class="me-4" id="category-svg">
                ...
                <div v-else class="col text-black-50 ms-2 align-self-center fs-5" role="button">
                    Kateqoriya
                    <span class="text-danger text-opacity-75">*</span>

                    <div class="invalid-feedback fs-6 error__letter_spacing" id="category-error">
                        Kateqoriya seçin!
                    </div>
                </div>
